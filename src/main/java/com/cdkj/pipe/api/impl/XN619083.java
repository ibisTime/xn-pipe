...
import com.cdkj.pipe.dto.req.XN619083Req;
 ...
 * 上架新闻
 * @author: xieyj 
 * @since: 2017年3月12日 下午6:22:36 
 * @history:
 */
public class XN619083 extends AProcessor {
    private INewsAO newsAO = SpringContextHolder.getBean(INewsAO.class);

    private XN619083Req req = null;

    @Override
    public Object doBusiness() throws BizException {
        Integer orderNo = StringValidater.toInteger(req.getOrderNo());
        newsAO.upNews(req.getCode(), req.getLocation(), orderNo,
            req.getUpdater());
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN619083Req.class);
