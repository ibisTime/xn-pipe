...
import com.cdkj.pipe.dto.req.XN619917Req;
 ...
 * @history:
 */
public class XN619917 extends AProcessor {
    private ISYSConfigAO sysConfigAO = SpringContextHolder
        .getBean(ISYSConfigAO.class);

    private XN619917Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN619917Req.class);
