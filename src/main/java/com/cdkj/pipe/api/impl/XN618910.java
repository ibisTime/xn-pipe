...
import com.cdkj.pipe.dto.req.XN618910Req;
 ...
 * @history:
 */
public class XN618910 extends AProcessor {

    private ISYSConfigAO sysConfigAO = SpringContextHolder
        .getBean(ISYSConfigAO.class);

    private XN618910Req req = null;
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN618910Req.class);
