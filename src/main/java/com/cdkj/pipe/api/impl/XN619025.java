...
import com.cdkj.pipe.dto.req.XN619025Req;
 ...
 * 经销商派单
 * @author: haiqingzheng 
 * @since: 2017年3月12日 上午11:43:51 
 * @history:
 */
public class XN619025 extends AProcessor {

    private IDemandAO demandAO = SpringContextHolder.getBean(IDemandAO.class);

    private XN619025Req req = null;
    ...
    public Object doBusiness() throws BizException {
        demandAO.assgin(req.getCode(), req.getUpdater(), req.getUserId());
    ...
    public void doCheck(String inputparams) throws ParaException {
        req = JsonUtil.json2Bean(inputparams, XN619025Req.class);
