...
public class AssignDAOImpl extends AMybatisTemplate implements IAssignDAO {
	...
	public Assign select(Assign condition) {
		return super.select(NAMESPACE.concat("select_assign"), condition,Assign.class);
	}


	@Override
	public Long selectTotalCount(Assign condition) {
		return super.selectTotalCount(NAMESPACE.concat("select_assign_count"),condition);
	}


	@Override
	public List<Assign> selectList(Assign condition) {
		return super.selectList(NAMESPACE.concat("select_assign"), condition,Assign.class);
	}


	@Override
	public List<Assign> selectList(Assign condition, int start, int count) {
		return super.selectList(NAMESPACE.concat("select_assign"), start, count,condition, Assign.class);
	}
