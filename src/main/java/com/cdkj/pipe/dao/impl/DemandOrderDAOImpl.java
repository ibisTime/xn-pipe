...
public class DemandOrderDAOImpl extends AMybatisTemplate implements IDemandOrderDAO {
	...
	public DemandOrder select(DemandOrder condition) {
		return super.select(NAMESPACE.concat("select_demandOrder"), condition,DemandOrder.class);
	}


	@Override
	public Long selectTotalCount(DemandOrder condition) {
		return super.selectTotalCount(NAMESPACE.concat("select_demandOrder_count"),condition);
	}


	@Override
	public List<DemandOrder> selectList(DemandOrder condition) {
		return super.selectList(NAMESPACE.concat("select_demandOrder"), condition,DemandOrder.class);
	}


	@Override
	public List<DemandOrder> selectList(DemandOrder condition, int start, int count) {
		return super.selectList(NAMESPACE.concat("select_demandOrder"), start, count,condition, DemandOrder.class);
	}
