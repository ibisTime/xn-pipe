...
public class HearDAOImpl extends AMybatisTemplate implements IHearDAO {
	...
	public Hear select(Hear condition) {
		return super.select(NAMESPACE.concat("select_hear"), condition,Hear.class);
	}


	@Override
	public Long selectTotalCount(Hear condition) {
		return super.selectTotalCount(NAMESPACE.concat("select_hear_count"),condition);
	}


	@Override
	public List<Hear> selectList(Hear condition) {
		return super.selectList(NAMESPACE.concat("select_hear"), condition,Hear.class);
	}


	@Override
	public List<Hear> selectList(Hear condition, int start, int count) {
		return super.selectList(NAMESPACE.concat("select_hear"), start, count,condition, Hear.class);
	}
